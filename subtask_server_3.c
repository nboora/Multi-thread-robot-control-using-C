...
void *client_thread (void* c_info)
{
    ...
    //Receive the message from the client
        ...
        if(strcmp(client_message,"s3_task1")==0)
        {
            ...
            strcat(server_message,",pick&place,");
            strcat(server_message,client_message);
            strcat(server_message," \n");
            strcat(server_message, "********************************************************************************\n\n");
            strcat(server_message, "The robot started to perform the pick & place objects task from the sub server-3\n\n");
            strcat(server_message, "********************************************************************************\n\n");
        }
        else
...
int main(int argc, char** argv) {
    ...
    char msg[100];
    char my_test_name[]="pick&place";       // defining the name of the testing
